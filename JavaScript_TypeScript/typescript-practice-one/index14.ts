...
interface FilterFunc {
    (): FilterFunc;
    <T>(filterer: (a: T) => boolean): FiltererFunc<T>;
    <T>(filterer: (a: T) => boolean, input: T[]): T[];
}
/**
 * 2 arguments passed: returns a new array
 ...
 * @return {Array | Function}
 */
export const filter = toFunctional(<T>(filterer: (a: T) => boolean, input: T[]) => input.filter(filterer)) as FilterFunc;


interface ReducererFunc<I, O> {
    (): ReducererFunc<I, O>;
    (input: I[]): O;
}
...
interface ReducerFunc<I, O> {
    (): ReducerFunc<I, O>;
    (initialValue: O): ReducererFunc<I, O>;
    (initialValue: O, input: I[]): O;
}

interface ReduceFunc {
    (): ReduceFunc;
    <I, O>(reducer: (a: O, b: I) => O): ReducerFunc<I, O>;
    <I, O>(reducer: (a: O, b: I) => O, initialValue: O): ReducererFunc<I, O>;
    <I, O>(reducer: (a: O, b: I) => O, initialValue: O, input: I[]): O;
}
/**
 ...
 * @return {* | Function}
 */
export const reduce = toFunctional(<I, O>(reducer: (a: O, b: I) => O, initialValue: O, input: I[]) => input.reduce(reducer, initialValue)) as ReduceFunc;
