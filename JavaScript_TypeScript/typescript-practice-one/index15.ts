...
export class ObjectManipulator<T> {
    ...
    public set<K extends string, V>(key: K, value: V): ObjectManipulator<T & {[NK in K]: V}> {
        return new ObjectManipulator({...this.obj, [key]: value}) as ObjectManipulator<T & {[NK in K]: V}>;
    }
